...
class AppNavigationScreen extends StatelessWidget {
  ...
  /// Navigates to the numberScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the [Navigator] widget
  /// to push the named route for the numberScreen.
  onTapNumber(BuildContext context) {
  ...
  onTapCode(BuildContext context) {
  ...
  onTapPassions(BuildContext context) {
  ...
  onTapMatch(BuildContext context) {
  ...
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the [Navigator] widget
  /// to push the named route for the photoFullsreenScreen.
  onTapPhotofullsreen(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.photoFullsreenScreen);
  }
}
