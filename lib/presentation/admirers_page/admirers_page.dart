...
class AdmirersPage extends StatefulWidget {
  @override
  _AdmirersPageState createState() => _AdmirersPageState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      appBar: CustomAppBar(
          ...
          centerTitle: true,
          title: AppbarTitle(text: "lbl_admirers".tr),
          actions: [
            AppbarIconbutton1(
                svgPath: ImageConstant.imgVolume,
                margin: EdgeInsets.only(left: 34.h, top: 23.v, right: 40.h))
          ]),
      body: SizedBox(
                        ...
                        Row(
                            ...
                            children: [
                              Padding(
                                  ...
                                  child:
                                      SizedBox(width: 121.h, child: Divider())),
                              Text("lbl_today".tr,
